...
import {
  hostCreateDirectoryRequestSchema, hostDescribeRequestSchema, hostGetBalanceRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'host.getBalance': { schema: hostGetBalanceRequestSchema, invoke: (api, r) => api.host.getBalance(r) },
